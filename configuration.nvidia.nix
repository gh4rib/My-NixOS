...
#    NIXOS_OZONE_WL = "1";
  ...
  # --- Graphics: NVIDIA Proprietary Hybrid ---
  ...
  hardware.nvidia = {
    ...
    # there are other nvidiaPackages like legacy_580!
    package = config.boot.kernelPackages.nvidiaPackages.productiob; 
  ...
  environment.systemPackages = with pkgs; [
    ...
    curl git alacritty gnome-boxes
    claws-mail ghostty python3 cifs-utils
